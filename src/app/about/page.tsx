  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-black mb-8 neon-text">À Propos de Maître Guide</h1>
        <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
          <p>
            Maître Guide est né d'une passion pour le sport et d'une volonté de rendre l'univers des paris en ligne plus transparent et accessible. 
