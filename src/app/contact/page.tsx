        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <p className="text-gray-300">
              Une suggestion, une interrogation ou un retour à partager sur l'une des plateformes de notre sélection ? 
              Notre équipe prend connaissance de chaque message reçu et s'engage à vous répondre dans les meilleurs délais.
            </p>
            <div className="space-y-4">
              <div className="flex items-center space-x-4 p-4 bg-panel border border-border rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">contact@prestigefr.com</p>
                </div>
              </div>
              <div className="flex items-center space-x-4 p-4 bg-panel border border-border rounded-xl">
                <span className="text-primary text-2xl">📍</span>
