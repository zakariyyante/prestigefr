          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Chaque site est testé pendant plusieurs semaines par nos parieurs professionnels.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="relative bg-panel backdrop-blur-lg border border-border p-8 rounded-2xl shadow-2xl">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3 text-gray-300">
                ...
                <span>Comparaison des cotes sur les grands événements</span>
              </li>
            </ul>
          </div>
        </div>
