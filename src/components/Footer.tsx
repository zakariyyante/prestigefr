      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Votre partenaire de confiance pour trouver les meilleurs sites de paris sportifs en France. 
              Nous analysons et comparons les plateformes pour vous offrir une expérience de jeu sécurisée.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-4 items-center">
               <a href="https://anj.fr" target="_blank" rel="noopener noreferrer" className="grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all">
        ...
        <div className="border-t border-border pt-8 text-center space-y-4">
          <div className="max-w-4xl mx-auto space-y-2 mb-4">
            ...
            <p className="text-gray-400 text-[11px] leading-relaxed">
              <span className="font-bold text-gray-300">Aucun service de plateforme :</span> Nous ne fournissons pas de services de plateforme. Tous les services sont offerts par des opérateurs tiers agréés.
            </p>
          </div>
          <p className="text-gray-500 text-xs">
            © {currentYear} Maître Guide. Tous droits réservés. Les paris sportifs sont interdits aux mineurs.
          </p>
          <div className="bg-panel/50 p-4 rounded-lg border border-border/50 text-[10px] text-gray-400 max-w-4xl mx-auto leading-relaxed">
            ...
            Cette interdiction est valable dans les casinos, dans les clubs de jeux, sur les sites de jeux et de paris en ligne exploités par les opérateurs de jeux agréés en France.
          </div>
        </div>
      </div>
    </footer>
